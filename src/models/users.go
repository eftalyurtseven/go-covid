...
var UserWhere = struct {
	...
	APIKey:    whereHelperstring{field: "`users`.`api_key`"},
...
var (
	userAllColumns            = []string{"id", "email", "api_key", "ip", "updated_at", "created_at"}
	userColumnsWithoutDefault = []string{"email", "api_key", "ip", "updated_at", "created_at"}
